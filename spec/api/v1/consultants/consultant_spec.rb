...
describe 'Consultant' do
  ...
  it 'should initialize with login, name and role' do
    ...
    consultant = API::V1::Consultants::Consultant.new login: expected_login, name: expected_name, role: expected_role
  ...
  it 'should get ThoughtWorks email' do
    consultant = API::V1::Consultants::Consultant.new login: 'johndoe', name: 'John Doe', role: 'Dev'
  ...
  it 'should deserialize from jigsaw json' do
    ...
    alice = API::V1::Consultants::Consultant.from_jigsaw_json json
  ...
  it 'should serialize to json' do
    bob = API::V1::Consultants::Consultant.new login: 'bob', role: 'Dev', name: 'Bob'
