  ...
  module V1
    describe 'Consultant' do
      ...
      it 'should initialize with login, name and role' do
        ...
        consultant = Consultants::Consultant.new login: expected_login, name: expected_name, role: expected_role
      ...
      it 'should serialize to json' do
        bob = Consultants::Consultant.new login: 'bob', role: 'Dev', name: 'Bob'
